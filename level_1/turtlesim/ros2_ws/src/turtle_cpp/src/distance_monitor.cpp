...
class DistanceMonitor : public rclcpp::Node { public: DistanceMonitor():Node("distance_monitor_cpp"){ sub_=create_subscription<std_msgs::msg::Float64>("/turtle_dist",13,[this](const auto m){RCLCPP_INFO(get_logger(),"distance=%.3f",m->data);}); RCLCPP_INFO(get_logger(),"distance C++ monitor started"); } private:rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr sub_;};
